...
src_files = [
    ["Static Panel", "gray", "Trial 2/static_96s.csv"],
    ...
    ["Tracking Panel, 2000ms Adjustment Time", "green", "Trial 2/tracker_2000ms_96s.csv"],
...
ax.scatter(intervals, energies, c=[i[1] for i in src_files])
ax.set_title("Adjustment Interval vs. Total Energy")
